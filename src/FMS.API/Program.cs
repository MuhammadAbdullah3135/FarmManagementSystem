...
// Queued offline mutations: applied by these same workflow services, one item per scope.
builder.Services.AddScoped<IMutationSyncService, MutationSyncService>();
