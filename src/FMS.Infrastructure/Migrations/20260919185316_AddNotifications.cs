        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationPreferences_Farms_FarmId",
                        column: x => x.FarmId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationPreferences_FarmId_UserId_AlertType",
                table: "NotificationPreferences",
                columns: new[] { "FarmId", "UserId", "AlertType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_FarmId_ResolvedAtUtc",
                table: "Notifications",
                columns: new[] { "FarmId", "ResolvedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_FarmId_UserId_SourceKey",
                table: "Notifications",
                columns: new[] { "FarmId", "UserId", "SourceKey" });
